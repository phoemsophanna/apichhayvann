...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Service::select("id", "title", "summary", "image", "isActive", "ordering")->orderBy('id', 'desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        ActivityLog::create([
            ...
            'module' => 'service',
            'description' => $request->id ? 'Updated Services:'.$request->title : 'Created Services:'.$request->title,
    ...
    public function destroy(string $id)
    {
        ...
        ActivityLog::create([
            ...
            'action' => 'delete',
            'module' => 'service',
            'description' => 'Deleted Services:'.$model->title,
            'ip_address' => request()->ip(),
            'user_agent' => request()->userAgent(),
        ]);
        $model->delete();
